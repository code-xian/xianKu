    ...
    <div class="mod-config">
        <el-form :inline="true" :model="dataForm" @keyup.enter.native="init()">
            ...
            <el-form-item label="发货单号" >
                <el-input  placeholder="请输入发货单号" clearable v-model="dataForm.fahuoId"></el-input>
            </el-form-item>
            <el-form-item>
...
<!--                <el-button  type="primary" @click="add()">新增</el-button>-->
        ...
        <div class="tableData">
            <el-table
                ...
                <el-table-column
                    ...
                    <template slot-scope="scope">
                        <div slot="reference">
                            {{ scope.row.fahuoStatus=="12"?"未审核":scope.row.fahuoStatus=="10"?"审核通过":scope.row.fahuoStatus=="11"?"审核未通过":"" }}
                        </div>
                    </template>
                </el-table-column>
                <el-table-column
                ...
                <el-table-column
                        ...
                        label="操作">
                    <template slot-scope="scope">
                        <el-button type="primary" size="mini"  @click="audit(scope.row.fahuoId,true,scope.row.purchaseAmount)" v-if="scope.row.fahuoStatus==12">审核</el-button>
                        <el-button type="primary" size="mini"  @click="audit(scope.row.fahuoId,false,scope.row.purchaseAmount)" v-if="scope.row.fahuoStatus==10||scope.row.fahuoStatus==11">详情</el-button>
                    </template>
                </el-table-column>
            </el-table>
            <el-pagination
        ...
        <fahuo-audit  v-if="auditVisible" ref="audit" @refreshDataList="init"></fahuo-audit>
    </div>
</template>
